...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.stoma.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.stoma.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.stoma.domain.Person.class.getName() + ".addresses");
            createCache(cm, com.stoma.domain.Person.class.getName() + ".visits");
            createCache(cm, com.stoma.domain.Doctor.class.getName());
            createCache(cm, com.stoma.domain.Doctor.class.getName() + ".addresses");
            createCache(cm, com.stoma.domain.Doctor.class.getName() + ".visits");
