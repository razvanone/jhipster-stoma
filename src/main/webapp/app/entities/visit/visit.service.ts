...
export class VisitService {
  ...
  protected convertDateFromClient(visit: IVisit): IVisit {
    const copy: IVisit = Object.assign({}, visit, {
      ...
      updatedDate: visit.updatedDate && visit.updatedDate.isValid() ? visit.updatedDate.toJSON() : undefined,
      targetDate: visit.targetDate && visit.targetDate.isValid() ? visit.targetDate.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((visit: IVisit) => {
        ...
        visit.updatedDate = visit.updatedDate ? moment(visit.updatedDate) : undefined;
        visit.targetDate = visit.targetDate ? moment(visit.targetDate) : undefined;
      });
    }
    return res;
  }
